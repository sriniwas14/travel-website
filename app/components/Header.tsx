...
export default function Header() {
    return (
        <div className='flex' style={{ background: `url('${bgImage.src}')`, height: '80vh', backgroundSize: "cover", backgroundPosition: "center", backgroundAttachment: "fixed" }}>
            <div className='w-1/2 m-auto text-center py-10'>
                <h2 className='text-gray-600 text-3xl'>Subhead One</h2>
                <h1 className='text-white text-6xl'>Website.com</h1>
                <h2 className='text-gray-600 text-3xl mb-8'>Subhead Two</h2>
                <div className='grid w-2/3 mx-auto'>
                    <div className='grid grid-cols-3 gap-3 flex'>
                        ...
                        <input type="date" className='w-full p-3' placeholder='Arrival Date' />
                        <input type="date" className='w-full p-3' placeholder='Leave Date' />
                    </div>
